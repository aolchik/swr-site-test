...
//          
//      Generate a static css with tailwind
//        pnpx tailwindcss -o ./public/styles-preview.css
//          @TODO: rodar geração no build / dev
//          Identificar origem da diferença de estilos
//
//    REFERENCES
...
// @TODO: Será que problema está aqui? Onde está o getLayout?
// @TODO: mock useRouter - https://jamespotz.github.io/blog/how-to-mock-userouter
const NextraPage = __nextra_withLayout__({
...
function Nextra(page) {
  console.dir(NextraPage, { depth: null })
  return NextraPage.getLayout(page);
}
...
// @TODO: Test <MDXContent> ? (nextra loader.ts)

const NextraPagePreviewTemplate = ({ entry }) => {
  //console.dir(__nextra_layoutConfig__, { depth: null })
 

  // @TODO: Por que não renderiza todos os componentes da NextraPage
  return (
    <Nextra>
      <NextraPage>
        <MDX
