...
Publicado em ${new Date(release.published_at).toLocaleDateString("pt-BR")}.\n\n${body}`}).join('\n\n')
  }</Markdown>
}

# Change Log

Por favor visite a [página de lançamentos do SWR](https://github.com/ercel/swr/releases) para ver todo o histórico de lançamentos.
